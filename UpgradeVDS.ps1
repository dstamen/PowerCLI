...
If ($Cluster.DrsEnabled -like "True") {
    ...
    Get-VDSwitch -Name $VDSwitch | Export-VDSwitch -Description "My Backup" -Destination "/Users/dstamen/Downloads/VDSBackup-$VDswitch-$((Get-Date).ToString(‘yyyy-MM-dd-hh-mm’)).zip"
